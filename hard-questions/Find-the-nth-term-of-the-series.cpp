...
// • The Nth term that is calculated by the program should be 
// written to STDOUT. 
// • Other than value of n th term,no other character / string 
// or message should be written to STDOUT. 
// • For example , if N=16, the 16th term in the series is 
...
// • Expected Output – 64 
// Explanation 
// 1, 1, 2, 3, 4, 9, 8, 27, 16, 81, 32, 243,64, 729, 128, 2187 can 
// represented as : 
// • 2(0), 3(0),2(1), 3(1),2(2), 3(2),2(3), 3(3),2(4), 3(4),2(5), 
// 3(5),2(6), 3(6) …. 
// There are two consecutive sub GP’s at even and odd positions 
// • (GP-1) At Odd Positions (Powers of 2) – 1, 2, 4, 8, 16, 
// 32, 64, 128 
// • (GP-2) At Even Positions (Powers of 3) – 1, 3, 9, 27, 81, 
// 243, 729, 2187 
...
int main(){
    int n; cin>>n;
    long long ans;
    if(n%2==1) ans=pow(2,n/2);      // odd position: power of 2
    else ans=pow(3,n/2);             // even position: power of 3
    cout<<ans;
}